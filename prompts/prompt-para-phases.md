...
There should be an initial phase dedicated to setting up frontend configurations, including defining colors and building basic UI components such as buttons, inputs, selects, checkboxes, radio buttons, and modals (see docs/design).

This phase should also include creating the base layout for both authenticated and non-authenticated users.

Note: This initial frontend setup phase does not require automated tests.