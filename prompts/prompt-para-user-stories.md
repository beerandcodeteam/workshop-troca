Look at the file `@docs/project-description.md` @docs/game_rules.md, @docs/jogo-original/* and @docs/design/* and work out user stories for the project.
...
Atention: For this project, the AI integration will be entirely done manually by me. Therefore, the project development should go up to the implementation of the game mechanics; my implementation is where the user stories should stop when waiting for the opponent to enter.
