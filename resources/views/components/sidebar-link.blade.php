...
>
    @switch($icon)
        @case('arena')
            ...
            @break
        @case('leaderboard')
            <svg class="size-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 10h4v11H3zM10 3h4v18h-4zM17 7h4v14h-4z"/></svg>
            @break
        @case('settings')
